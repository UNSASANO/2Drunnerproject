...
public class Spawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //Use Random.Range to pick a number between 0 and the amount of items we have on our objects list
            int selection = Random.Range(0, objectsToSpawn.Length);


            //Instantiate spawns a GameObjects - in this case we tell it to spawn a GameObject from our object list
            ...
            //After spawning, we select a new random time for next spawn and set our timer back to zero
            timeToNextSpawn = Random.Range(minSpawnTime, maxSpawnTime);
